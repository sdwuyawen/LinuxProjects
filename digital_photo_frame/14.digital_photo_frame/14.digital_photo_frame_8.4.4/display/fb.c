...
static int FBShowPage(PT_VideoMem ptVideoMem)
{
	...
	DBG_PRINTF("pucDispMem = %08x, tPixelDatas.aucPixelDatas = %08x, tPixelDatas.iTotalBytes = %d\n", 
				(unsigned int)g_tFBOpr.pucDispMem, (unsigned int)ptVideoMem->tPixelDatas.aucPixelDatas, ptVideoMem->tPixelDatas.iTotalBytes);
